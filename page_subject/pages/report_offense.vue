<template>
	<view>
		<view class="centerAlign left-right-margin" style="margin-top: 30rpx;">
			<textarea maxlength="1024" class="input-textarea" v-model="reportText" :placeholder="reportTextPlaceHolder"
				inputBorder="false" />
		</view>
...
export default {
	...
	methods: {
		...
		async confirmBtnOnClick() {
			...
			const resp = await api.reportOffense(parseInt(this.toUserID), this.reportText, imageURLs)
